...
class Dog: # this creates a class named dog
    energy = "high" # sets an attribute for the class

    def speak(self): # creates a method (like a function)
        print("bark")
...
class Students:
    pass #avoid getting error, same as None
...
class Student:
    def __init__(self, first, last, age): # __indicates a background task__
        self.first = first    # init method intitialises the object with these attributes.
